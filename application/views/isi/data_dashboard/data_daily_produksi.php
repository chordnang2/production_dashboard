...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo base_url(); ?>assets/mhaicon.png" type="image/x-icon" />
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/mhaicon.png" />
    <!-- Title -->
...
<body class="app sidebar-mini rtl">
                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        <ol class="breadcrumb">
                            ...
                            <li style="color: #007bff;" class="breadcrumb-item"><a href="<?= base_url('daily_produksi') ?>"><i class="fa fa-play" data-toggle="tooltip" title="" data-original-title="fa fa-play"></i> Data Terupdate = <?php echo $datapelengkap2[0]['maxdate'] ?></a></li>
                        ...
                        <div class="ml-auto">
                            <div class="input-group">
                                <form action="<?= base_url('daily_produksi/select'); ?>" method="get">
                                    ...
                                    <input type="date" class="btn btn-primary text-white mr-2" name="tanggal_akhir" id="" value="<?= $tanggal_akhir ?>">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal3" title="Terkahir Update Tanggal = <?php echo  $datapelengkap[0]['maxdate'] ?>">Data Pelengkap</a>
                                        <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal4" title="Terkahir Update Tanggal = <?php echo  $datatarget[0]['maxdate'] ?>">Data Target</a>
                                    </div>
                                ...
                                <form action="<?= base_url('daily_produksi/export_select_excel'); ?>" method="get">
                                    <!-- <input style="width:160px;" class="btn btn-primary text-white mr-2" type="text" name="daterange" /> -->
                                    <input type="hidden" class="btn btn-primary text-white mr-2" name="tanggal_akhir" id="" value="<?= $tanggal_akhir ?>">
                                    <button class="btn btn-success text-white mr-2" type="submit" value="Submit">Export</button>
                                </form>
                                <?php } else { } ?>
                                ...
                                <div class="row">
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $ton_siang[0]['sumnett'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $ton_malam[0]['sumnett'] ?></h2>

                                                </div>
                                            </div>
                                            <h5 class="text-white">Total Ton</h5>
                                            <h2 class="  mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $ton[0]['sumnett'] ?></h2>
                                            <span class=" text-white">tonase</span>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $trip_siang[0]['sumtrip'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $trip_malam[0]['sumtrip'] ?></h2>
                                                </div>
                                            </div>
                                            <h5 class=" text-white">Total Trip</h5>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $avgton_siang[0]['avgnett'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $avgton_malam[0]['avgnett'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $avgdistance_siang[0]['avgdistance'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $avgdistance_malam[0]['avgdistance'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $sumdistance_siang[0]['sumdistance'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $sumdistance_malam[0]['sumdistance']  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $totaltonkm_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $totaltonkm_malam ?></h2>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $ratarataunitreadysiang[0]['ratarataunitready'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $ratarataunitreadymalam[0]['ratarataunitready']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $unitservice_siang[0]['unitservice']  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $unitservice_malam[0]['unitservice']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $unitbreakdown_siang[0]['unitbreakdown']  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $unitbreakdown_malam[0]['unitbreakdown']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $totalhm_siang[0]['wh'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $totalhm_malam[0]['wh']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $totalbdsiang[0]['totalbd'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $totalbdmalam[0]['totalbd']  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $pasiang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $pamalam ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $ma_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $ma_malam ?></h2>
                                ...
                                <div class="row">
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            ...
                                            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $datapelengkap[0]['jumlahoperator_siang'] + $datapelengkap[0]['jumlahoperator_malam'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            ...
                                            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $datapelengkap[0]['jumlahoperatorsiapoperasi_siang'] + $datapelengkap[0]['jumlahoperatorsiapoperasi_malam'] ?></h2>
                                            <span class="text-white">orang</span>
                                            <!-- <p>target 44488 ton</p> -->
                                            <div class="progress progress-sm mb-0">
                                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-info w-<?php echo ROUND(16316 / 44488 * 100) ?>"></div>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $unitchangeshift3035_siang[0]['unitchangeshift3035'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $unitchangeshift3035_malam[0]['unitchangeshift3035'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $standby_time_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $standby_time_malam ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $breakdownsiang[0]['breakdown'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $breakdownmalam[0]['breakdown']  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $change_shiftsiang[0]['change_shift'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $change_shiftmalam[0]['change_shift']  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $refuelingsiang[0]['refueling']  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $refuelingmalam[0]['refueling']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $antri_loading_siang  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $antri_loading_malam  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $antri_dumping_siang[0]['antri_dumping']   ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $antri_dumping_malam[0]['antri_dumping']   ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $rest_time_siang[0]['rest_time']  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $rest_time_malam[0]['rest_time'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $cycle_time_siang[0]['cycle_time']  ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo $cycle_time_malam[0]['cycle_time'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo   $travel_time_siang[0]['travel_time'] ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo  $travel_time_malam[0]['travel_time'] ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo    $ewh_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo   $ewh_malam  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo    $ua_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo   $ua_malam  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo    $kecepatanratarata_siang ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo   $kecepatanratarata_malam  ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($datapelengkap[0]['fuelconsumtionunittrailer_siang'], 2) ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo   round($datapelengkap[0]['fuelconsumtionunittrailer_malam'], 2) ?></h2>

                                                </div>
                                            </div>
                                            <h5 class="text-white">Fuel Consumtion</h5>
                                            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailer, 2) ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerliterton_siang, 2) ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerliterton_malam, 2) ?></h2>

                                                </div>
                                            </div>
                                            <h5 class="text-white">Fuel Index Unit Trailer</h5>
                                            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerliterton, 2) ?></h2>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h5 class=" label_hasil text-white">Shift 1 </h5>
                                                    <h2 class="hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerlitertonkm_siang, 3) ?></h2>
                                                </div>
                                                <div class="col-lg-6">
                                                    <h5 class="label_hasil text-white">Shift 2</h5>
                                                    <h2 class=" hasil mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerlitertonkm_malam, 3) ?></h2>

                                                </div>
                                            </div>
                                            <h5 class="text-white">Fuel Index Unit Trailer</h5>
                                            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue"><?php echo round($fuelindextrailerlitertonkm, 2) ?></h2>
    ...
    <!-- Datepicker js -->
    <script src="<?php echo base_url(); ?>/assets/hogo/assets/plugins/date-picker/spectrum.js"></script>
    <script src="<?php echo base_url(); ?>/assets/hogo/assets/plugins/date-picker/jquery-ui.js"></script>
    <script src="<?php echo base_url(); ?>/assets/hogo/assets/plugins/input-mask/jquery.maskedinput.js"></script>
    <script>
        $(function() {
