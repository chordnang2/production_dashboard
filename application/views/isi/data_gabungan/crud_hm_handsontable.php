                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             <h3>FORM ADD EDIT HAPUS DATA HM</h3>
                         </div>

                         <!-- /.card-header -->

                         <form action="<?php echo base_url() ?>Hm_controller/loadajaxhanson" method="GET">
                         ...
                         <?php if ($date) { ?>
                             ...
                             <script type="text/javascript">
                                 ...
                                 Handsontable.dom.addEvent(save, 'click', () => {
                                     ...
                                     ajax('<?php echo base_url() ?>Hm_controller/ajaxHandson', 'POST', JSON.stringify({
                                         data: hot.getData()
                                     }), res => {
                                 ...
                                 rev.addEventListener('click', function() {
                                     hot.updateSettings({
                                         data: Handsontable.helper.translateRowsToColumns(hot.getData())
                                     })
                                 });
                             </script>
