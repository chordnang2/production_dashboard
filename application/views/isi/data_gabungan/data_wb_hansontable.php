                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             <h3>FORM ADD EDIT HAPUS DATA TIMBANGAN</h3>
                         </div>

                         <!-- /.card-header -->

                         <form action="<?php echo base_url() ?>Isi_wb/loadajaxhanson" method="GET">
                         ...
                         <?php if ($date) { ?>
                             ...
                             <script type="text/javascript">
                                 ...
                                 const hot = new Handsontable(container, {
                                     ...
                                     colHeaders: ['Shift', 'No Unit', 'Tipe Vessel', 'Loading Point', 'Type', 'WB', 'No Transaksi', 'Gross', 'Tare', 'Nett', 'Time In', 'Time Out', 'Tipping', 'Rmrk', 'Target', 'Percent', 'Loss weight', 'Keterangan', 'Status', 'Tanggal', ],
                                     height: 'auto',
                                 ...
                                 Handsontable.dom.addEvent(save, 'click', () => {
                                     ...
                                     ajax('<?php echo base_url() ?>Isi_wb/ajaxHandson', 'POST', JSON.stringify({
                                         data: hot.getData()
                                     }), res => {
