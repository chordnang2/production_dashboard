                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             <h3>FORM ADD EDIT HAPUS DATA Gunungsari</h3>
                         </div>

                         <!-- /.card-header -->

                         <form action="<?php echo base_url() ?>Isi_wb/loadajaxhanson_gunungsari" method="GET">
                         ...
                         <code>'Update terakhir tanggal <?= $last_date_update_gunungsari[0]['date']; ?>'</code>
                         <?php if ($date) { ?>
                             ...
                             <script type="text/javascript">
                                 ...
                                 const hot = new Handsontable(container, {
                                     ...
                                     colHeaders: ['date', 'nrp', 'driver_1', 'nrp2', 'driver_2', 'unit', 'vessel_type', 'shift', 'r', 'trip', 'time_in', 'time_out', 'dari', 'ke', 'tonase', 'gross', 'tare', 'nett', 'id_transaksi', 'tipe_coal', 'wb'],
                                     height: 'auto',
                                 ...
                                 Handsontable.dom.addEvent(save, 'click', () => {
                                     ...
                                     ajax('<?php echo base_url() ?>Isi_wb/ajaxHandson_gunungsari', 'POST', JSON.stringify({
                                         data: hot.getData()
                                     }), res => {
