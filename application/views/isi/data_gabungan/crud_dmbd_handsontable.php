                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             <h3>FORM ADD EDIT HAPUS DATA DMBD</h3>
                         </div>

                         <!-- /.card-header -->

                         <form action="<?php echo base_url() ?>Dmbd_controller/loadajaxhanson" method="GET">
                         ...
                         <?php if ($date) { ?>
                             ...
                             <script type="text/javascript">
                                 ...
                                 const hot = new Handsontable(container, {
                                     ...
                                     colHeaders: ['bulan', 'date', 'mo', 'kode_unit', 'kode_vessel', 'model_unit', 'model_vessel', 'hm', 'km', 'task', 'job_type', 'kerusakan', 'jenis_perbaikan', 'jam_mulai', 'jam_selesai', 'total_bd', 'status', 'lokasi', 'remark', 'pic', 'pa', 'shift'],
                                     height: 'auto',
                                 ...
                                 Handsontable.dom.addEvent(save, 'click', () => {
                                     ...
                                     ajax('<?php echo base_url() ?>Dmbd_controller/ajaxHandson', 'POST', JSON.stringify({
                                         data: hot.getData()
                                     }), res => {
