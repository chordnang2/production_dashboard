                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             <h3>FORM ADD EDIT HAPUS DATA DISPATCH UNIT BELUM READY</h3>
                         </div>
                         <!-- /.card-header -->

                         <form action="<?php echo base_url() ?>Isi_bd_dispatch/loadajaxhanson_byOperasi" method="GET">
                         ...
                         <script type="text/javascript">
                             ...
                             const hot = new Handsontable(container, {
                                 ...
                                 colHeaders: ['date', 'shift', 'no_unit', 'problem', 'aktivity', 'preparation', 'start', 'time_out', 'operasi', 'hm', 'km', 'location', ],
                                 height: 'auto',
                                 ...
                                 columns: [{
                                         ...
                                         type: 'autocomplete',
                                         source: ['ACCIDENT', 'BREAKDOWN', 'GREASING', 'REFUELING', 'REPAIR', 'REPLACE', 'RETORQUE', 'SERVICE', 'CHANGE SHIFT', 'REST AND MEAL', 'STANDBY READY'],
                                         strict: true,
                                         allowInvalid: false
                                     }, {}, {}, {}, {}, {},
                                     {}, {}
                             ...
                             Handsontable.dom.addEvent(save, 'click', () => {
                                 ...
                                 ajax('<?php echo base_url() ?>Isi_bd_dispatch/ajaxHandson_byOperasi', 'POST', JSON.stringify({
                                     data: hot.getData()
                                 }), res => {
