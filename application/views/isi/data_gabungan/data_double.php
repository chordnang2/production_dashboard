                                  ...
                                  <tbody>
                                      ...
                                      <?php foreach ($wb as $wba) : ?>
                                          <tr>
                                              <td> </td>
                                              <td>
                                                  <a href="<?= base_url() ?>isi_wb/edit_double/<?= $wba->no_transaction ?>" class="btn btn-small"><i class="fas fa-edit"></i> Ubah</a>
                                                  <a href="<?= base_url() ?>isi_wb/delete_wb_double/<?= $wba->id_wb ?>" class="btn btn-small text-danger"><i class="fas fa-trash"></i>Hapus</a>
                                              </td>
                                              <td><?php echo $i++ ?></td>
