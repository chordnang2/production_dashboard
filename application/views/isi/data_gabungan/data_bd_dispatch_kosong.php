                  ...
                  <div class="col-12">
                      ...
                      <div class="card-body">
                          <!-- <div class="col-4">
                              ...
                              <a href="<?php echo base_url("Isi_bd_dispatch/export_today"); ?>"> <button style="width: 100%;" class="btn btn-block btn-outline-info float-right">Exsport ke Excel Data Hari ini</button></a>
                          </div> -->
  ...
  <script>
      $(document).ready(function() {
          ...
          function load_data() {
              $.ajax({
                  url: "<?= base_url(); ?>/Isi_bd_dispatch/load_kosong",
                  dataType: "JSON",
