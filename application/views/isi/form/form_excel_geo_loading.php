  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1>Form Import Excel Geofence Loading</h1>
                  </div>
                  <div class="col-sm-6">
      ...
      <section class="content">
          <div class="container-fluid ">
              ...
              <div class="card card-default">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                      <form method="post" action="<?php echo site_url('Isi_geofence/form_geofence_loading') ?>" enctype="multipart/form-data">
          ...
          <?php
            if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form 
                ...
                echo "<form method='post' action='" . base_url("Isi_geofence/import_loading") . "'>";
    ...
    <tr>
      ...
      <th>Durasi Parkir</th>
                ...
                foreach ($sheet as $row) {
                    ...
                    $description = $row['C']; // Insert data jenis kelamin dari kolom C di excel
