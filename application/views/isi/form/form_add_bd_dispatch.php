          ...
          <div class="container-fluid">
              ...
              <div class="card card-default">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-md-12">
                              <form action="<?php echo site_url('Isi_bd_dispatch/add_vessel') ?>" method="post" enctype="multipart/form-data">
                                  <div class="row">
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label>TANGGAL*</label>
                                              <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                  <input type="text" name="tanggal" class="form-control datetimepicker-input <?php echo form_error('tanggal') ? 'is-invalid' : '' ?>" data-target="#reservationdate" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input class="form-control <?php echo form_error('problem') ? 'is-invalid' : '' ?>" type="text" name="problem" />
                                              <?php echo form_error('problem') ?>
                                          </div>
                                          <div class="form-group">
                                              <label for="aktivity">AKTIFITAS*</label>
                                              <input class="form-control <?php echo form_error('aktivity') ? 'is-invalid' : '' ?>" type="text" name="aktivity" />
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date " id="timepicker1" data-target-input="nearest">
                                                  <input type="text" name="preparation" class="form-control datetimepicker-input <?php echo form_error('preparation') ? 'is-invalid' : '' ?>" data-target="#timepicker1" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker2" data-target-input="nearest">
                                                  <input type="text" name="start" class="form-control datetimepicker-input <?php echo form_error('start') ? 'is-invalid' : '' ?>" data-target="#timepicker2" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker4" data-target-input="nearest">
                                                  <input type="text" name="time_out" class="form-control datetimepicker-input <?php echo form_error('time_out') ? 'is-invalid' : '' ?>" data-target="#timepicker4" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker5" data-target-input="nearest">
                                                  <input type="text" name="time_operasi" class="form-control datetimepicker-input <?php echo form_error('time_operasi') ? 'is-invalid' : '' ?>" data-target="#timepicker5" />
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker3" data-target-input="nearest">
                                                  <input type="text" name="waiting_satu" class="form-control datetimepicker-input <?php echo form_error('waiting_satu') ? 'is-invalid' : '' ?>" data-target="#timepicker3" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker6" data-target-input="nearest">
                                                  <input type="text" name="waiting_dua" class="form-control datetimepicker-input <?php echo form_error('waiting_dua') ? 'is-invalid' : '' ?>" data-target="#timepicker6" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker7" data-target-input="nearest">
                                                  <input type="text" name="total" class="form-control datetimepicker-input <?php echo form_error('total') ? 'is-invalid' : '' ?>" data-target="#timepicker7" />
                                          ...
                                          <!-- <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker8" data-target-input="nearest">
                                                  <input type="text" name="total_hours" class="form-control datetimepicker-input <?php echo form_error('total_hours') ? 'is-invalid' : '' ?>" data-target="#timepicker8" />
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input class="form-control <?php echo form_error('hm') ? 'is-invalid' : '' ?>" type="text" name="hm" />

                                              <?php echo form_error('hm') ?>
                                          </div>
                                          <div class="form-group">
                                              <label for="km">KM*</label>
                                              <input class="form-control <?php echo form_error('km') ? 'is-invalid' : '' ?>" type="text" name="km" />
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              ...
                                              <input class="form-control <?php echo form_error('location') ? 'is-invalid' : '' ?>" type="text" name="location" />
                                          ...
                                          <!-- <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker9" data-target-input="nearest">
                                                  <input type="text" name="antrian_satu" class="form-control datetimepicker-input <?php echo form_error('antrian_satu') ? 'is-invalid' : '' ?>" data-target="#timepicker9" />
                                          ...
                                          <!-- <div class="form-group">
                                              ...
                                              <div class="input-group date" id="timepicker10" data-target-input="nearest">
                                                  <input type="text" name="antrian_dua" class="form-control datetimepicker-input <?php echo form_error('antrian_dua') ? 'is-invalid' : '' ?>" data-target="#timepicker9" />
