        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($cek_login == FALSE) {
                ...
                if (password_verify($pass, $cek_login->password)) {
                    ...
                    if ($this->session->userdata('username') == "timbangan") {
                        redirect('Isi_highlight/pro_jam');
                    } else if ($this->session->userdata('username') == "dispatch") {
                        redirect('isi_highlight/produktifitas_unit_asli');
                    } else {
                        redirect('Isi_highlight/pro_jam');
                    }
                } else {
