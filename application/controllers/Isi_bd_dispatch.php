...
class Isi_bd_dispatch extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Isi_bd_dispatch_model', 'MLiveTable');
    }
    ...
    public function loadajaxhanson_byOperasi()
    {


        $data["data"] = $this->MLiveTable->wb_hanson_byOperasi();
        ...
        $this->load->view('template/template_table/template_atas_table_hanson');
        $this->load->view('template/template_kiri');
        $this->load->view('isi/data_gabungan/crud_bd_km6_byOperasi', $data);
    }

    public function ajaxHandson_byOperasi()
    {
        $data = (array) json_decode(file_get_contents('php://input'), true);
        $data = $data['data'];
        $temp['result'] = $this->MLiveTable->update_handson_byOperasi($data);
        echo json_encode($temp);
    }
}
