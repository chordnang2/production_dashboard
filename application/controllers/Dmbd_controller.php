...
class Dmbd_controller extends CI_Controller
{
    ...
    public function loadajaxhanson()
    {
        if ($this->input->get('date')) {
            ...
            $data['data'] = $this->Isi_dmbd_model->wb_hanson($data);
        ...
        $data['last_date_update'] = $this->Isi_highlight_model->dmbd();
        $this->load->view('template/template_table/template_atas_table_hanson');
        $this->load->view('template/template_kiri');
        $this->load->view('isi/data_gabungan/crud_dmbd_handsontable', $data);
    }
    ...
    public function ajaxHandson()
    {
        ...
        $data = $data['data'];
        $temp['result'] = $this->Isi_dmbd_model->update_handson($data);
